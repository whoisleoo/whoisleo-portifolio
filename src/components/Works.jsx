  ...
  return (
    <>
      ...
      >
        ...
        >
          <h2 style={{ fontFamily: "IBMPlex, sans-serif" }}>-SELECTED WORK-</h2>
        </div>
                  ...
                  <div className="mb-4">
                    <div className="relative">
                      ...
                      <div className="flex items-start justify-between">
                        <h3
                          className={`text-8xl leading-none tracking-wide group-hover:tracking-wider transition-all duration-500 border-b py-2 ${
                        ...
                        <div
                          className={`w-12 h-12 ${
                            isDark
                              ? "bg-white text-black"
                              : "bg-black text-white"
                          } rounded-lg flex items-center justify-center p-3 ml-4 mt-2 group-hover:scale-110 transition-all`}
                        >
                          <svg
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <p
                        ...
                        } leading-relaxed max-w-sm text-left`}
