...
function Work() {
    ...
    return (
        <>
          <section className="min-h-screen bg-black text-white py-40 px-6 relative overflow-hidden">
            <div className="text-center mb-60">
                <h2 className="text-sm tracking-wider text-gray-400" style={{ fontFamily: 'IBMPlex, sans-serif' }}>
                    -ABOUT ME-
                </h2>
            </div>
                ...
                <div className="text-center mb-15">
                    <div className="flex justify-center items-baseline gap-8 relative">
                        ...
                        <div className="relative">
                            ...
                            <p className="text-3xl tracking-wider text-white absolute -bottom-8 left-19 whitespace-nowrap" style={{ fontFamily: 'Disket, sans-serif' }}>
                               SOFTWARE DEVELOPER
                            </p>
                            </HoverEffect>
                        </div>
                ...
                <div className="grid grid-cols-2 gap-10 items-center ml-10">
                    ...
                    <div className="pt-16">
                        ...
                        <div className="pt-30 flex justify-end">
                            <HoverEffect>
                                <button className="group flex items-center gap-3 border border-white/30 rounded-3xl px-8 py-4 hover:border-white/60 transition-all duration-300">
